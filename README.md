...
65 unit tests covering event schemas, Reddit/GitHub watcher parsing and
...
reconciler live under `tests/features/` (run against a real homeserver
when `KNARR_ADMIN_PASSWORD` is set; otherwise skip).
